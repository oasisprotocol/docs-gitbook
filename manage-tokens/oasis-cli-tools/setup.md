...
The following commands are intended to be run on your local machine and only need access to the network's current [Genesis File](../../oasis-network/genesis-doc.md) and your signer's private key:
