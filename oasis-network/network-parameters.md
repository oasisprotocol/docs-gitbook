...
* Runtime binary version (or [build your own](https://github.com/oasisprotocol/emerald-paratime/tree/v4.0.0#building)):
  * [4.0.0](https://github.com/oasisprotocol/emerald-paratime/releases/tag/v4.0.0)
